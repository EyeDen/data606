...
_The cases are the births for the station of North Carolina.  We have 1000 cases in our sample._
...
_The median weight of babies from smokers is lower than the median weight of babies from nonsmokers.  In fact, their median weight is more in line with the median weight of all babies._
...
_We seem to have a large enough sample size for both to assume a normal distribution._
...
_The average length of pregnancies for North Carolina women seems to be 40 weeks._
...
_After finding out how the data set separates the mature column, we simply take the max of younger mom, and min of mature mom.  The cut off for younger mothers is 34._
...
$H_{0}: \mu_{weeks+white} = \mu_{weeks+nonwhite}$
$H_{A}: \mu_{weeks+white} \neq \mu_{weeks+nonwhite}$

_Hypothesis is that the length of pregnancies between white and nonwhite women are different._
...
_With a p-value of only 0.0076, we affirm the null hypothesis.  Average length of pregnancies for white and nonwhite women are the same in North Carolina._
